...
public class accessexcel extends javax.swing.JFrame {
...
{  
    ...
    try
    {
        ...
        while(rs.next())
        {
            ...
            String veh=rs.getString("Remark");
            String []rowdata={dt,name,addr,no,eng,eng1,veh};
            dm.addRow(rowdata);
        }
        return dm;
    }
   ...
   for(int i=0;i<dm.getRowCount();i++)
    ...
    Set<String>ids=data.keySet();
      ...
      for(String key:ids)
      {
          ...
          FileOutputStream fos=new FileOutputStream(new File("D:/motors/accessexcel.xlsx"));
          wb.write(fos);
          fos.close();
    ...
    private void initComponents() {
        ...
        setTitle("bharathmotors/accessories/excel");
        ...
        jScrollPane1.setBounds(40, 90, 680, 400);
        ...
        jButton1.setBounds(820, 90, 110, 50);
        ...
        jButton2.setBounds(820, 200, 110, 50);
        ...
        jButton3.setBounds(820, 320, 110, 50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(accessexcel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new accessexcel().setVisible(true);
            }
        });
    }
