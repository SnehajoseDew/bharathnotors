...
public void table()
{
    try
    {     
          String sql="select * from accessories order by Date asc";
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(270, 190, 830, 420);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 28)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 153));
        jLabel1.setText("BHARATHMOTORS");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(250, 11, 282, 38);

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 20)); // NOI18N
        jLabel2.setText("ACCESSORIES");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(280, 140, 258, 31);
