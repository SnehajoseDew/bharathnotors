...
public class billmotors extends javax.swing.JFrame {
     String pd="";
     int no1;
     int tamount=0;
     String rate1;
...
public void CurrentDate()
    ...
    private void initComponents() {
        ...
        Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sl.No", "Type", "Item_Name", "Tax%", "Qty", "Rate", "Amount"
            }
        ));
    ...
    private void ListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_ListValueChanged
        ...
        try
        {
            String sql="SELECT  TYPE,ITEM_NAME,QUANTITY,MRP FROM MOTORS WHERE ITEM_NAME='"+List.getSelectedValue()+"'";
           Class.forName("com.mysql.jdbc.Driver");
            Connection con= (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/bharatmotors","root","");
            Statement stmt=con.createStatement();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            stmt2.executeUpdate("UPDATE MOTORS SET QUANTITY=QUANTITY-'"+qty1+"' WHERE ITEM_NAME='"+part+"'");
         }
        catch(Exception e)
        {
            JOptionPane.showMessageDialog(null,e.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(billmotors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new billmotors().setVisible(true);
            }
        });
    }
