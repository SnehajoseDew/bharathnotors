...
public class accessupdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(400, 210, 60, 20);

        jLabel3.setText("Item_Name");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(400, 280, 70, 20);

        jLabel5.setText("Quantity");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(400, 350, 70, 20);

        jLabel6.setText("In_Price");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(400, 410, 70, 20);

        jLabel7.setText("MRP");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(400, 470, 70, 20);
        getContentPane().add(partno);
        partno.setBounds(520, 200, 400, 40);
        getContentPane().add(itemname);
        itemname.setBounds(520, 270, 400, 40);
        getContentPane().add(quantity);
        quantity.setBounds(520, 340, 400, 40);
        getContentPane().add(price);
        price.setBounds(520, 400, 400, 40);
        getContentPane().add(mrp);
        mrp.setBounds(520, 460, 400, 40);
        ...
        jButton1.setBounds(400, 620, 110, 50);
        ...
        jButton2.setBounds(610, 620, 110, 50);
        ...
        jButton3.setBounds(810, 620, 110, 50);

        jLabel8.setText("Search");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(10, 170, 60, 30);
        ...
        search.setBounds(50, 170, 230, 30);
        ...
        jScrollPane2.setBounds(520, 520, 410, 70);

        jLabel10.setText("Remark");
        getContentPane().add(jLabel10);
        jLabel10.setBounds(400, 534, 90, 30);
        getContentPane().add(date);
        date.setBounds(520, 130, 400, 40);
        ...
        jScrollPane3.setBounds(50, 210, 240, 140);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            Connection con= (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/bharatmotors","root","");
            Statement stmt=con.createStatement();
            String sql="UPDATE ACCESSORIES SET  PART_NO='"+partno.getText()+"',ITEM_NAME='"+itemname.getText()+"',QUANTITY='"+quantity.getText()+"',IN_PRICE='"+price.getText()+"',MRP='"+mrp.getText()+"',REMARK='"+remark.getText()+"' WHERE ITEM_NAME='"+List.getSelectedValue()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(accessupdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new accessupdate().setVisible(true);
            }
        });
    }
