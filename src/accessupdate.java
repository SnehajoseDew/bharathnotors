...
public class accessupdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(270, 30, 380, 40);

        jLabel2.setText("Part_No");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(410, 210, 60, 20);

        jLabel3.setText("Item_Name");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(410, 260, 70, 20);

        jLabel4.setText("Model");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(410, 310, 80, 20);

        jLabel5.setText("Quantity");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(410, 360, 70, 20);

        jLabel6.setText("In_Price");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(410, 410, 70, 20);

        jLabel7.setText("MRP");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(410, 460, 70, 20);
        getContentPane().add(partno);
        partno.setBounds(520, 200, 400, 30);
        getContentPane().add(itemname);
        itemname.setBounds(520, 250, 400, 30);
        getContentPane().add(model);
        model.setBounds(520, 300, 400, 30);
        getContentPane().add(quantity);
        quantity.setBounds(520, 350, 400, 30);
        getContentPane().add(price);
        price.setBounds(520, 400, 400, 30);
        getContentPane().add(mrp);
        mrp.setBounds(520, 450, 400, 30);
        ...
        jButton1.setBounds(410, 510, 80, 40);
        ...
        jButton2.setBounds(640, 510, 80, 40);
        ...
        jButton3.setBounds(840, 510, 90, 40);

        jLabel8.setText("Search");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(0, 150, 60, 20);
        ...
        jScrollPane1.setBounds(0, 200, 210, 410);

        jLabel9.setText("Date");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(410, 160, 70, 20);
        getContentPane().add(date);
        date.setBounds(520, 154, 400, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            Connection con= (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/bharatmotors","root","");
            Statement stmt=con.createStatement();
            String sql="UPDATE ACCESSORIES SET DATE='"+date.getText()+"', PART_NO='"+partno.getText()+"',ITEM_NAME='"+itemname.getText()+"',QUANTITY='"+quantity.getText()+"',IN_PRICE='"+price.getText()+"',MRP='"+mrp.getText()+"',MODEL='"+model.getText()+"' WHERE ITEM_NAME='"+List.getSelectedValue()+"'";
