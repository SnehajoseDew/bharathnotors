...
{  
    ...
    try
    {
        ...
        while(rs.next())
        {
            ...
            String []rowdata={dt,name,addr,veh,no,eng,eng1,dt1,name1,addr1,veh1,no1,eng2,eng3,eng4,eng5};
            dm.addRow(rowdata);
        }
        return dm;
    }
...
private void writeToExcel() throws FileNotFoundException, IOException
{
    ...
    data.put("-1",new Object[]{dm.getColumnName(0),dm.getColumnName(1),dm.getColumnName(2),dm.getColumnName(3),dm.getColumnName(4),dm.getColumnName(5),dm.getColumnName(6),dm.getColumnName(7),dm.getColumnName(8),dm.getColumnName(9),dm.getColumnName(10),dm.getColumnName(11),dm.getColumnName(12),dm.getColumnName(13),dm.getColumnName(14),dm.getColumnName(15)});
   for(int i=0;i<dm.getRowCount();i++)
    {
     
        data.put(Integer.toString(i),new Object[]{getCellValue(i,0),getCellValue(i,1),getCellValue(i,2),getCellValue(i,3),getCellValue(i,4),getCellValue(i,5),getCellValue(i,6),getCellValue(i,7),getCellValue(i,8),getCellValue(i,9),getCellValue(i,10),getCellValue(i,11),getCellValue(i,12),getCellValue(i,13),getCellValue(i,14),getCellValue(i,15)});
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:export
         try {
            // TODO add your handling code here:
            writeToExcel();
