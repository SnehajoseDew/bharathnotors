...
public class Report1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(820, 150, 90, 30);
        getContentPane().add(date);
        date.setBounds(106, 145, 278, 27);

        jLabel2.setText("TO");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(416, 145, 14, 27);
        ...
        jButton2.setBounds(830, 480, 90, 30);
        ...
        jButton3.setBounds(830, 430, 90, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // model.setColumnIdentifiers(columnNames);
        ...
        int i=0;
        String sql="SELECT DATE, BUYERNAME,ADDRESS,CLASS_VEHICLE,CHASSIS_NO,ENGINE_NO,COLOR FROM DETAILS WHERE DATE BETWEEN '"+dat+"' AND '"+dat2+"' ORDER BY DATE ASC";
        try {
           ...
           /* while(rs.next())
            {
              ...
              String buy = rs.getString("BUYERNAME");
               String class1 = rs.getString("CLASS_VEHICLE");
               String cha = rs.getString("CHASSIS_NO");
                String eng = rs.getString("ENGINE_NO");
                 String col = rs.getString("COLOR");
               DefaultTableModel model=(DefaultTableModel) table.getModel();
           model.addRow(new Object[]{dt,buy,class1,cha,eng,col}); 
                i++; 
            }*/
