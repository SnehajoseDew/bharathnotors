...
public class Report1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("bharatmotors/salereport");
        getContentPane().setLayout(null);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel1.setText("Date");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 110, 68, 27);
        ...
        jButton1.setBounds(820, 150, 90, 40);
        getContentPane().add(date);
        date.setBounds(106, 145, 278, 27);

        jLabel2.setText("TO");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(406, 145, 30, 27);
        getContentPane().add(dat1);
        dat1.setBounds(458, 145, 305, 27);

        jLabel3.setText("FROM");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(40, 150, 60, 20);

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 153));
        jLabel4.setText("BHARATH  MOTORS");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(340, 30, 320, 50);
        ...
        jButton2.setBounds(320, 460, 130, 50);
        ...
        jScrollPane2.setBounds(0, 230, 910, 180);
        ...
        jButton3.setBounds(610, 460, 120, 50);
        ...
        cmd_print.setBounds(70, 460, 130, 50);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         //String[] columnNames = {"DATE", "BUYERNAME", "ADDRESS", "CLASS_VEHICLE","ENGINE_NO","COLOR"};
        String dat=date.getText();
        String dat2=dat1.getText();
        // DefaultTableModel model = new DefaultTableModel();
       // model.setColumnIdentifiers(columnNames);
        
        int i=0;
        String sql="SELECT * FROM SALE WHERE DATE BETWEEN '"+dat+"' AND '"+dat2+"' ORDER BY DATE ASC";
        try {
