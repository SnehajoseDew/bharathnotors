 ...
 * @author Digital
 */
public class sparepupdate extends javax.swing.JFrame {

    /**
     * Creates new form sparepupdate
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(310, 50, 360, 50);

        jLabel2.setText("Part_No");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(410, 170, 70, 20);

        jLabel3.setText("Item_Name");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(410, 230, 70, 20);

        jLabel4.setText("Model");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(410, 300, 50, 20);

        jLabel5.setText("Quantity");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(410, 360, 50, 20);

        jLabel6.setText("In_Price");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(410, 430, 50, 20);

        jLabel7.setText("MRP");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(410, 500, 60, 20);
        getContentPane().add(partno);
        partno.setBounds(560, 160, 380, 40);
        getContentPane().add(itemname);
        itemname.setBounds(560, 220, 380, 40);
        getContentPane().add(model);
        model.setBounds(560, 290, 380, 40);
        getContentPane().add(quantity);
        quantity.setBounds(560, 350, 380, 40);
        getContentPane().add(price);
        price.setBounds(560, 420, 380, 40);
        getContentPane().add(mrp);
        mrp.setBounds(560, 490, 380, 40);
        ...
        jButton1.setBounds(440, 570, 100, 40);
        ...
        jButton2.setBounds(640, 570, 100, 40);

        jButton3.setText("Back");
        getContentPane().add(jButton3);
        jButton3.setBounds(850, 570, 100, 40);

        jLabel8.setText("Search");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(10, 164, 60, 20);
        getContentPane().add(search);
        search.setBounds(10, 190, 260, 30);
        ...
        jScrollPane1.setBounds(10, 230, 260, 460);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sparepupdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sparepupdate().setVisible(true);
            }
        });
    }
