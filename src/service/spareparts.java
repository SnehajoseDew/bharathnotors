...
public class spareparts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("bharathmotors_spareparts");
        getContentPane().setLayout(null);

        jLabel1.setText("Part_No");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(360, 120, 70, 29);
        getContentPane().add(partno);
        partno.setBounds(550, 120, 310, 30);

        jLabel2.setText("Item_Name");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(360, 170, 61, 20);
        getContentPane().add(itemname);
        itemname.setBounds(550, 170, 310, 30);

        jLabel3.setText("Model");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(360, 220, 61, 22);
        getContentPane().add(model);
        model.setBounds(550, 220, 310, 30);

        jLabel4.setText("In_Price");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(360, 270, 61, 20);
        getContentPane().add(price);
        price.setBounds(550, 270, 310, 30);
        ...
        jButton2.setBounds(660, 400, 90, 40);
        getContentPane().add(mrp);
        mrp.setBounds(550, 320, 310, 30);

        jLabel5.setText("MRP");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(360, 320, 60, 20);

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 153));
        jLabel6.setText("BHARAT MOTORS");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(420, 30, 260, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       partno.setText(part);
        String sql="insert into spareparts values('"+part+"','"+name+"','"+mode+"','"+Price+"','"+mrp1+"')";
