...
public void CurrentDate()
    ...
    private void initComponents() {
        ...
        setTitle("bharathmotors/accessories\n\n");
        getContentPane().setLayout(null);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jLabel1.setText("Part_No");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(270, 220, 80, 30);

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jLabel2.setText("Item_Name");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(270, 290, 80, 30);

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jLabel4.setText("Quantity");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(270, 350, 60, 30);
        getContentPane().add(partno);
        partno.setBounds(410, 210, 460, 40);
        getContentPane().add(itemname);
        itemname.setBounds(410, 280, 460, 40);
        ...
        jLabel5.setBounds(270, 420, 60, 30);
        getContentPane().add(price);
        price.setBounds(410, 410, 460, 40);

        jLabel6.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jLabel6.setText("MRP");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(270, 480, 70, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Price=price.getText();
         ...
         price.setText("");
         mrp.setText("");
        String sql="insert into accessories values('"+date1+"','"+part+"','"+name+"','"+qty+"','"+Price+"','"+mrp1+"','"+mode+"')";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       accessupdate u=new accessupdate();
       u.setVisible(true);
       setVisible(false);
